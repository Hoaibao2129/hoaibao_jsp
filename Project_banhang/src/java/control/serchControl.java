 ...
 * @author ASUS
 */
@WebServlet(name = "serchControl", urlPatterns = {"/serchControl"})
public class serchControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO dao = new DAO();
        int SLsearch = dao.getSoluongSpsearch("txt");
        
        List<Product> listSearch = dao.getProductsbySearch(search);
        ...
        request.setAttribute("SLsearch", SLsearch);
