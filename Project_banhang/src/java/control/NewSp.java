 ...
 * @author ASUS
 */
@WebServlet(name = "NewSp", urlPatterns = {"/NewSp"})
public class NewSp extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      List<Product> listspnew = dao.getAllNewsp();
        ...
        request.setAttribute("listP", listspnew);
