 ...
 * @author ASUS
 */
@WebServlet(name = "chiTietspControl", urlPatterns = {"/chiTietsp"})
public class chiTietspControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Product> listcateID = dao.getProductsbyCID1(cateID);
        ...
        request.setAttribute("chiTietsp", p);
        request.setAttribute("listcateID", listcateID);
        ...
        request.getRequestDispatcher("producrt.jsp").forward(request, response);
    }
